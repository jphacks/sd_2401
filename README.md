...
## 製品概要
自分の好きなモノをもとに楽しく英語スピーキングを学習できるアプリ

### 背景(製品開発のきっかけ、課題等）
英語の学習習慣がまったく身につかない学生生活を義務教育時代から続いています。
「英語勉強は楽しくないモノ」という認識をしている人が世の中にも多いのではと考え、まずは楽しく継続して学習できる英語アプリを開発しようと考えました。

加えて私達のメンバーは、今後国際学会やグローバルな場で活躍していく中で自分の「テーマに対して英語で論理的に説明する力」につまずくのではないかと考えました。

この２つの問題を一気に改善するために、従来の英語アプリのようなビジネス・日常会話・道案内などの退屈なテーマでスピーキングを学ばない、むしろ自分のエゴに従い、好きなコンテンツでスピーキング練習できるアプリ「Eigoイスト」を開発しました。

従来のアプリが「日常会話」、「ビジネス」、「道案内」などの生活に関わるテーマなどの固定のテーマを取り扱うことで評価を簡単にしている一方で、「Eigoイスト」ではユーザー毎の様々なテーマを評価する仕組みを導入することで論理的に説明する力の強化
...
自分の密接に関わるテーマ、動画、ニュースでスピーチ練習を行えるので、モチベーションが維持できます。きっと、私達は何事も自分の好きなことなら継続して取り組めるのでこのアプリでは無限に英語を話すでしょう。

#### 2. スピーチの内容面での評価にもこだわっています
テーマに関するスピーチ内容の一貫性評価、スピーチ構成の評価、スピーチに個人の体験がうまく組み込まれているかを評価、語彙、表現の多様性の評価を観点として重視しています。これによりユーザーに内容、論理構成がはっきりしていて、オリジナリティあるスピーチを行うよう促進します。
...
これにより、既存アプリのビジネス英会話・日常会話を超えた、「本当の」日常や自分の趣味の話題に関わるのスピーチを行うことができます。


### 製品説明（具体的な製品の説明）
自分にあった形で、楽しく効果的にスピーキングを勉強できます！
...
加えて、スピーチの内容が当たり障りのないものではなく、独自性(ニュースであれば関連知識ではなく、ニュースの本文の内容を話しているか等)があるかを採点することで、真面目に取り組む習慣も導入しています。
